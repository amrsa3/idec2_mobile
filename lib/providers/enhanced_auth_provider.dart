...
/// Provider محسن للمصادقة يدعم جميع المنصات
class EnhancedAuthProvider extends StateNotifier<AuthState> {
  final UnifiedAuthService _authService;

  EnhancedAuthProvider(this._authService) : super(const AuthState.initial()) {
    _initialize();
  }
  ...
  Future<AuthResult> requestOtp({
    ...
    try {
      return await _authService.requestOtp(
        phone: phone,
        purpose: purpose,
      );
    } catch (e) {
      debugPrint('❌ [ENHANCED_AUTH_PROVIDER] OTP request error: $e');
  ...
  Future<AuthResult> verifyOtp({
    ...
    try {
      ...
      debugPrint('❌ [ENHANCED_AUTH_PROVIDER] OTP verification error: $e');
  ...
  Future<bool> isSessionValid() async {
    try {
      ...
      debugPrint('❌ [ENHANCED_AUTH_PROVIDER] Session validation error: $e');
      return false;
    }
  }
  ...
  Future<UserModel?> getCurrentUser() async {
    try {
      ...
      debugPrint('❌ [ENHANCED_AUTH_PROVIDER] Get current user error: $e');
      return null;
    }
  }
  ...
  Future<bool> refreshToken() async {
    try {
      ...
      debugPrint('❌ [ENHANCED_AUTH_PROVIDER] Token refresh error: $e');
      return false;
    }
  }
...
final enhancedAuthProvider =
    StateNotifierProvider<EnhancedAuthProvider, AuthState>((ref) {
  final authService = ref.watch(unifiedAuthServiceProvider);
  return EnhancedAuthProvider(authService);
});
