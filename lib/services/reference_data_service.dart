...
class ReferenceDataService {
  static final ReferenceDataService _instance = ReferenceDataService._internal();
  ...
  Future<List<GovernorateModel>> getGovernorates() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        _governorates = data.map((json) => GovernorateModel.fromJson(json)).toList();
        return _governorates!;
      } else {
  ...
  Future<List<QualificationModel>> getQualifications() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        _qualifications = data.map((json) => QualificationModel.fromJson(json)).toList();
        return _qualifications!;
      } else {
