...
void main() async {
  ...
  try {
    ...
    final healthResponse = await dio.get('http://idec-ye.com:3000/health');
    ...
    try {
      ...
      if (e is DioException && e.response?.statusCode == 400) {
        print(
            '✅ Auth endpoint accessible (400 expected for invalid credentials)');
      } else {
    ...
    try {
      final usersResponse =
          await dio.get('http://idec-ye.com:3000/api/v1/users');
    ...
    try {
      final govResponse = await dio
          .get('http://idec-ye.com:3000/api/v1/rule-data/governorates');
    ...
    try {
      final qualResponse = await dio
          .get('http://idec-ye.com:3000/api/v1/rule-data/qualifications');
    ...
    try {
      final profileResponse =
          await dio.get('http://idec-ye.com:3000/api/v1/profiles/me');
